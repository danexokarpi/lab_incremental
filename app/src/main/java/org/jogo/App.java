...
public class App {
    ...
    private static ArrayList<Carta> criaBaralho() {
        CartaDano revolver = new CartaDano("Revolver", "O bom o velho conquistador do Oeste.", 1, 3, "Unico");
        CartaDano espingarda = new CartaDano("Espingarda", "Nada melhor do que chumbo grosso para acabar com eles.", 2,
                4, "Unico");
        CartaDano escopeta = new CartaDano("Escopeta Cerrada",
                ...
                "Todos");
        CartaDano granada = new CartaDano("Granada", "3,2,1....KABUMMM!!!!!!.", 3, 4, "Todos");
        ...
        CartaEfeito frascoDeVeneno = new CartaEfeito("Frasco de Veneno",
                "Um pequeno fraco com veneno concentrado, lance apenas em inimigos!", 2,
                new FabricaDeEfeito("veneno", 3), "Unico");
        CartaEfeito gas_mostarda = new CartaEfeito("Gás Mostarda",
                "Uma arma quimica extremamente tóxica que afeta uma grande área.", 3, new FabricaDeEfeito("veneno", 2),
                "Todos");
        Carta[] listaBaralho = { revolver, espingarda, escopeta, mina_antipessoal, granada, escudoEletromagneticoGrande,
                escudoEletromagneticoPequeno, escudoEletromagneticoSobrecarregado, stimPack, frascoDeVeneno,
                gas_mostarda };
